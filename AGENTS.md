...
- Every PR body must include a note at the top or bottom explicitly stating **"🤖 Generated by Claude Code (AI)"** to make it clear the work was done by an AI agent, not a human.
...
- **PRs do not require approval — merge them directly after creation.** No human review is needed unless explicitly requested.
