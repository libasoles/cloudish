              ...
              <li key={t.id}>
                <NavLink
                  ...
                  style={({ isActive }) => ({
                    ...
                    color: isActive ? 'hsl(var(--accent-foreground))' : 'var(--text)',
                  })}
                >
                  {t.title}
                </NavLink>
      ...
      <main className="flex-1 min-w-0">
        {!tutorial ? (
          <div className="flex flex-col items-center justify-center h-screen gap-4">
            <p className="text-4xl font-bold" style={{ color: 'var(--text-h)' }}>404</p>
          ...
          <div className="max-w-3xl mx-auto px-6 py-12">
            ...
            <header className="mb-10">
              ...
              <h1 className="text-4xl font-bold mb-3" style={{ color: 'var(--text-h)', lineHeight: 1.15 }}>
                {tutorial.title}
              </h1>
            ...
            >
              <p className="font-semibold mb-3" style={{ color: 'var(--text-h)' }}>En esta página</p>
            ...
            <div className="docs-content">
              {TutorialContent ? (
                <Suspense fallback={<div className="py-20 text-center opacity-40">Cargando…</div>}>
                  <TutorialContent />
                </Suspense>
              ) : (
            ...
            {tutorial.sections.map((s) => (
              <li key={s.id}>
                <a
                  ...
                  style={{
                    color: activeSection === s.id ? 'hsl(var(--primary))' : 'var(--text)',
