...
export const multiAzThreeTierArchitectureNodes = [
  container("region", "region", "AWS Region: us-east-1", { x: 230, y: 70 }, { width: 1240, height: 720 }),
  container("vpc", "vpc", "VPC - 10.0.0.0/16", { x: 40, y: 55 }, { width: 1160, height: 560 }, "region"),
  container("az-a", "az", "AZ-A (us-east-1a)", { x: 35, y: 80 }, { width: 535, height: 450 }, "vpc"),
  container("az-b", "az", "AZ-B (us-east-1b)", { x: 590, y: 80 }, { width: 535, height: 450 }, "vpc"),
  container(
    "pub-subnet-a",
    "subnet",
    "Public Subnet AZ-A - 10.0.1.0/24",
    { x: 20, y: 45 },
    { width: 495, height: 135 },
    "az-a",
    { subnetType: "Public" },
  ),
  container(
  ...
  service("web-client", "Web", "html5", "Clients", "web-client", { x: 65, y: 250 }),
  service("route53-node", "Route 53", "aws-amazon-route-53", "Networking", "route53", { x: 65, y: 390 }),
  service("s3-node", "S3", "aws-amazon-simple-storage-service", "Storage", "s3", { x: 430, y: 610 }, "region"),
  service("cloudwatch-node", "CloudWatch", "aws-amazon-cloudwatch", "Management", "cloudwatch", { x: 830, y: 610 }, "region"),
  service(
    "igw-node",
    "Internet Gateway",
  ...
  service("alb-node", "ALB", "aws-elastic-load-balancing", "Networking", "elb", { x: 515, y: 105 }, "vpc"),
  service(
    "nat-gw-a",
    "NAT Gateway",
  ...
  service("ec2-a", "EC2", "aws-res-amazon-ec2-instance", "Compute", "ec2", { x: 65, y: 45 }, "asg-a"),
  service("ec2-b", "EC2", "aws-res-amazon-ec2-instance", "Compute", "ec2", { x: 65, y: 45 }, "asg-b"),
  service(
    "elasticache-a",
    "ElastiCache AZ-A",
  ...
  service("rds-primary", "RDS Primary", "aws-amazon-rds", "Database", "rds", { x: 325, y: 120 }, "priv-subnet-a"),
  service("rds-standby", "RDS Standby", "aws-amazon-rds", "Database", "rds", { x: 325, y: 120 }, "priv-subnet-b"),
];
...
export const multiAzThreeTierArchitectureViewport = { x: 15, y: 20, zoom: 0.72 };
