...
export const UI_TEXT = {
  en: {
    ...
    position: "Position",
    clickNodeDetails: "Click a node to see its details.",
  ...
  es: {
    ...
    position: "Posicion",
    clickNodeDetails: "Selecciona un nodo para ver sus detalles.",
...
const EN_SERVICE_DESCRIPTIONS: Record<string, string> = {
  ...
  lambda:
    "Runs code without managing servers, responding to events on demand.",
  ...
  backup: "Centralizes and automates backups for AWS resources and applications.",
  "s3-glacier": "Low-cost S3 storage classes for archive and long-term retention.",
  ...
  aurora: "AWS-optimized relational database compatible with MySQL and PostgreSQL.",
  elasticache: "Managed in-memory cache compatible with Redis, Valkey, and Memcached.",
  ...
  "api-gateway": "Creates, publishes, protects, and monitors REST, HTTP, and WebSocket APIs.",
  "direct-connect": "Dedicated network connection between your facilities and AWS.",
  "transit-gateway": "Managed hub for connecting VPCs and on-premises networks at scale.",
  "app-mesh": "Service mesh for controlling and observing communication between microservices.",
  "global-accelerator": "Improves availability and performance using the AWS global network.",
  privatelink:
  ...
  "secrets-manager": "Stores, rotates, and retrieves secrets such as credentials and API keys.",
  guardduty:
    "Detects threats by analyzing AWS account, workload, and data activity.",
  "security-hub": "Centralizes findings and security posture across AWS accounts and services.",
  inspector: "Automatically scans workloads, containers, and functions for vulnerabilities.",
  ...
  quicksight: "Managed business intelligence for dashboards, visualizations, and embedded analytics.",
  "lake-formation": "Creates, secures, and manages data lakes on AWS with centralized governance.",
  msk: "Managed service for running Apache Kafka-compatible workloads on AWS.",
  opensearch: "Search, log analytics, and observability using managed OpenSearch.",
  ...
  rekognition: "Analyzes images and videos to detect objects, text, faces, and content.",
  ...
  comprehend: "Extracts entities, sentiment, language, and topics from text with NLP.",
  bedrock: "Builds generative AI applications using managed foundation models.",
  kendra: "Intelligent enterprise search across documents and corporate data sources.",
  ...
  codepipeline: "Orchestrates continuous delivery pipelines for software changes.",
  ...
  cloudwatch: "Monitors metrics, logs, events, and alarms for resources and applications.",
  cloudformation: "Models and provisions AWS infrastructure as code.",
  "systems-manager": "Manages operations, configuration, and automation of resources at scale.",
  config: "Records resource configurations and evaluates compliance against rules.",
  cloudtrail: "Records account activity and API calls for auditing and security.",
  organizations: "Manages multiple AWS accounts with centralized policies and billing.",
  "control-tower": "Sets up and governs multi-account AWS environments using best practices.",
  "service-catalog": "Creates and distributes approved catalogs of cloud products and resources.",
  ...
  eventbridge: "Serverless event bus for connecting applications, SaaS, and AWS services.",
  "step-functions": "Orchestrates visual workflows that coordinate services and tasks.",
