...
export const UI_TEXT = {
  ...
  es: {
    ...
    availabilityZone: "AZ",
    dragAz: "Arrastrar AZ",
    azDescription: "Zona de Disponibilidad dentro de una VPC o Region.",
    ...
    authSignInTitle: "Iniciar sesion",
...
const ES_FIELD_KEY_TRANSLATIONS: FieldTranslations = {
  ...
  backupRetentionDays: { label: "Retencion de backup (dias)" },
  billingMode: {
  ...
  collaborationName: { label: "Nombre de colaboracion" },
  computeEnvironmentName: { label: "Nombre del entorno de computo" },
  computePlatform: { label: "Plataforma de computo" },
  computeType: { label: "Tipo de computo" },
  connectionName: { label: "Nombre de conexion" },
  connectionSpeed: { label: "Velocidad de conexion" },
  ...
  dataCatalogName: { label: "Nombre del catalogo de datos" },
  ...
  defaultAction: { label: "Accion por defecto" },
  defaultRouteTableAssociation: {
    label: "Asociacion por defecto a tabla de rutas",
  },
  deletionProtection: { label: "Proteccion contra eliminacion" },
  ...
  eksProtectionEnabled: { label: "Proteccion de EKS habilitada" },
  ...
  engine: { label: "Motor" },
  engineVersion: { label: "Version del motor" },
  environment: {
    label: "Entorno",
    options: { dev: "Desarrollo", staging: "Staging", prod: "Produccion" },
  },
  ...
  feature: { label: "Caracteristica" },
  fileSystemName: { label: "Nombre del sistema de archivos" },
  fileSystemType: { label: "Tipo de sistema de archivos" },
  findingExportEnabled: { label: "Exportacion de hallazgos habilitada" },
  forecastFrequency: { label: "Frecuencia de pronostico" },
  ...
  indexName: { label: "Nombre del indice" },
  ...
  keySpec: { label: "Especificacion de clave" },
  ...
  magneticStoreRetentionDays: {
    label: "Retencion en magnetic store (dias)",
  },
  maxCapacity: { label: "Capacidad maxima" },
  maxVcpus: { label: "vCPUs maximas" },
  memoryMiB: { label: "Memoria (MiB)" },
  memoryStoreRetentionHours: {
    label: "Retencion en memory store (horas)",
  },
  meshName: { label: "Nombre del mesh" },
  mfaEnabled: { label: "MFA habilitado" },
  minCapacity: { label: "Capacidad minima" },
  ...
  outputLocation: { label: "Ubicacion de salida" },
  ...
  pointInTimeRecovery: { label: "Recuperacion point-in-time" },
  ...
  protectionLevel: { label: "Nivel de proteccion" },
  protocol: { label: "Protocolo" },
  publicAccess: { label: "Acceso publico" },
  purchaseOption: {
    label: "Opcion de compra",
    options: {
      "on-demand": "On-Demand",
      spot: "Spot",
  ...
  recordingEnabled: { label: "Grabacion habilitada" },
  region: {
    label: "Region",
    options: {
  ...
  retrievalTier: { label: "Nivel de recuperacion" },
  roleName: { label: "Nombre del rol", placeholder: "mi-rol" },
  rotationEnabled: { label: "Rotacion habilitada" },
  routingPolicy: { label: "Politica de ruteo" },
  ruleType: { label: "Tipo de regla" },
  runtime: { label: "Runtime" },
  s3ProtectionEnabled: { label: "Proteccion de S3 habilitada" },
  ...
  securityStandardsEnabled: { label: "Estandares de seguridad habilitados" },
  ...
  stage: { label: "Stage" },
  standardsEnabled: { label: "Estandares de seguridad habilitados" },
  ...
  validationMethod: { label: "Metodo de validacion" },
  vaultName: { label: "Nombre del vault" },
  versioning: { label: "Versionado" },
  viewerProtocolPolicy: { label: "Politica de protocolo del viewer" },
