...
export const UI_TEXT = {
  en: {
    ...
    solidLineToggle: "Solid line",
    dashedLineToggle: "Dashed line",
    animated: "Animated",
    animatedToggle: "Toggle animation",
    type: "Type",
    public: "Public",
    private: "Private",
    ...
    exportImageError: "Could not export image. Please try again.",
    ...
    searchRelatedServices: "Related services",
    loadMore: "Load more",
  ...
  es: {
    ...
    solidLineToggle: "Línea sólida",
    dashedLineToggle: "Línea punteada",
    animated: "Animada",
    animatedToggle: "Activar animación",
    type: "Tipo",
    public: "Pública",
    private: "Privada",
    subnetLabel: (subnetType: string, index: number) =>
    ...
    exportImageError: "No se pudo exportar la imagen. Intentá de nuevo.",
    ...
    searchRelatedServices: "Servicios relacionados",
    loadMore: "Cargar más",
