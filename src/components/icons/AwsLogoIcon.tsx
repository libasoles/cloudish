type AwsLogoIconProps = {
  className?: string;
};

/**
 * AWS wordmark + smile, rendered monochrome with `currentColor` so it tints
 * with the surrounding text color on the dark UI (sidebar / search list).
 */
export function AwsLogoIcon({ className }: AwsLogoIconProps) {
  return (
    <svg
